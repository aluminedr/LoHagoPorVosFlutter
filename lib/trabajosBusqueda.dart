...
class ListarTrabajosBusqueda extends StatefulWidget{
  final String query;
  ListarTrabajosBusqueda({this.query});

  @override
  State<StatefulWidget> createState() => _ListarTrabajosBusquedaState();
  
  
  }
  
  class _ListarTrabajosBusquedaState extends State<ListarTrabajosBusqueda> with SingleTickerProviderStateMixin{
  ...
  Future<List> getListaTrabajos() async {
    ...
    var data = {
        'filtrar': widget.query,
        'eliminado' : 0, 
        'idEstado' : 1,
        'idPersonaDistinto' : localStorage.getInt('idPersona')
    };
    print('entre');
    var res = await CallApi().postData(data,'listarTrabajosBusqueda');
