...
class ValorarAnunciante extends StatefulWidget{
  final idPersonaLogeada;
  final idTrabajo;
  ValorarAnunciante(this.idPersonaLogeada, this.idTrabajo);

  @override
  _ValorarAnuncianteState createState() => _ValorarAnuncianteState();
}

class _ValorarAnuncianteState extends State<ValorarAnunciante> {
